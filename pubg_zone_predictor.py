...
if st.sidebar.button("Predict Next Zone"):
    if st.session_state.zones:
        ...
        # Bias edge shift: favor one direction subtly
        ...
        new_x = last_center[0] + shift_x
        new_y = last_center[1] + shift_y

        # Terrain/water avoidance logic (basic version: stay in bounds only)
